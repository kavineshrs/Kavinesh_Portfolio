...
const contactMethods = [
  {
    icon: Mail,
    label: 'Email',
    value: 'rskavinesh2004@gmail.com',
    href: 'mailto:rskavinesh2004@gmail.com',
    bg: 'bg-blue-700',
  ...
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/kavineshrs',
    href: 'https://github.com/kavineshrs',
    bg: 'bg-gray-700',
    iconColor: 'text-white',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/kavineshrs',
    href: 'https://linkedin.com/in/kavineshrs',
    bg: 'bg-blue-800',
    iconColor: 'text-white',
  },
];
...
const codingPlatforms = [
  {
    icon: LeetCodeIcon,
    label: 'LeetCode',
    href: 'https://leetcode.com/u/Kavinesh1811/',
    bg: 'bg-white',
    iconColor: '',
  },
  {
    icon: HackerRankIcon,
    label: 'HackerRank',
    href: 'https://www.hackerrank.com/profile/rskavinesh2004',
    bg: 'bg-white',
    iconColor: '',
  },
  {
    ...
    href: 'https://stackoverflow.com/users/30826350/kavinesh-r-s',
    bg: 'bg-white',
    iconColor: '',
  },
];
  ...
  <Card className="glowing-card bg-gray-900/70 border-gray-800 rounded-xl transition-all duration-300 overflow-hidden h-full flex flex-col justify-center">
    ...
    <CardContent>
      <p className="text-gray-300 text-base mb-8">
              I am a Full Stack and Machine Learning Engineer, specializing in building intelligent, scalable, and user-centric applications by integrating modern web technologies with AI/ML solutions.
            </p>
